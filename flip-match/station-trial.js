/* =========================================================================
   Flip Match - TRIAL station stub (window.WPStation)
   -------------------------------------------------------------------------
   ...
   Use it to try a card set, board size or branding, or to let people play
   for fun without a CCE Play account. The real station is index.html +
   station.js. Mirrors wp-bird/station-trial.js (only the label differs).
   ========================================================================= */
(function (global) {
  'use strict';

  var CFG = { game: '', gameLabel: 'FLIP MATCH', station: 'TRIAL' };
  var listeners = [];
